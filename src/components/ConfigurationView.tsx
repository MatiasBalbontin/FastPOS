              ...
              <div className="border border-[var(--line)] bg-gray-50/50 p-6 rounded-xl flex flex-col justify-between">
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-gray-500 leading-relaxed">
                    Utilice la <strong>Actualización Segura</strong> si desea conservar los cambios locales que se han programado. Use la <strong>Actualización Limpia</strong> si desea descartar toda prueba local y dejar el sistema exactamente como en GitHub.
                  </p>
                </div>
          ...
          <div className="bg-white border border-[var(--line)] w-full max-w-md rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              <p className="text-sm text-gray-600 leading-relaxed">
                <strong>ATENCIÓN:</strong> Esta acción ejecutará un reinicio completo del código local basándose en el servidor remoto de GitHub.
              </p>
